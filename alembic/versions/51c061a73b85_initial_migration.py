...
Revision ID: 51c061a73b85
Revises: 
Create Date: 2025-02-27 19:36:29.755219
...
def upgrade() -> None:
    ...
    op.create_table('api_status',
    sa.Column('api_group', sa.String(), nullable=False),
    sa.Column('status', sa.String(), nullable=False),
    sa.Column('last_checked', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('response_time', sa.Numeric(), nullable=True),
    ...
    op.create_index(op.f('ix_api_status_id'), 'api_status', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_faq_inquiries_id'), 'faq_inquiries', ['id'], unique=False)
    ...
    sa.Column('is_owner', sa.Boolean(), server_default='false', nullable=True),
    ...
    sa.Column('billing_cycle', sa.DateTime(), nullable=True),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['organisation_id'], ['organisations.id'], ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_table('faqs')
    op.drop_index(op.f('ix_faq_inquiries_id'), table_name='faq_inquiries')
    op.drop_table('faq_inquiries')
    op.drop_index(op.f('ix_email_templates_id'), table_name='email_templates')
    op.drop_table('email_templates')
    op.drop_index(op.f('ix_api_status_id'), table_name='api_status')
